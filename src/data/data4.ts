interface FormationCV4 {
  year: string;
  title: string;
  institution: string;
}

interface ContactCV4 {
  type: string;
  value: string;
}

interface SkillGroupCV4 {
  category: string;
  items: string[];
}

interface ExperienceCV4 {
  period: string;
  position: string;
  company: string;
  role: string;
...
export const skillsCV4: SkillGroupCV4[] = [
  ...
  {
    category: 'Intégration et services',
    items: [
...
export const experiencesCV4: ExperienceCV4[] = [
  {
    period: "2023 - Présent",
...
export const formationsCV4: FormationCV4[] = [
  {
    year: "2021",
    title: "Master mention informatique",
...
export const softSkillsCV4: string[] = [
...
export const contextCV4: string[] = [
...
export const languesCV4 = [
  { name: "Français", level: "langue maternelle" },
  { name: "Anglais technique", level: "professionnel" }
];
